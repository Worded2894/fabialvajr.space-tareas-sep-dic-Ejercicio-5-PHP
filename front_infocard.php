    ...
    <div>
        <div class="row  #e0f2f1 teal lighten-5">
            <div class="col s3 marginbottom #e0f2f1 teal lighten-5">
                ...
                <label id="descripcion_articulo"><h6><strong>Descripciones - Probar 3, 6, 7, 10 y 11.</strong></h6></label>
            </div>
            ...
            <div class="row">
              ...
              <div class="col l4 offset-l2 s12">
                ...
                <ul>
                  ...
                  <li><a class="grey-text text-lighten-3" href="http://fabialvajr.space/tareas-sep-dic/Ejercicio%205/">Ejercicio 5</a></li>
            </div>
          </div>
